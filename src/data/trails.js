...
export const trails = [
  ...
  },
  {
    ...
    conditions: 'Tempo estável. Levar água (mínimo 2L), belas cachoeiras e acessível para cadeirantes.',
  ...
  },
  {
    ...
    status: 'full',
    description:
      'Trilha interpretativa ideal para famílias. Rica em espécies de aves.',
    conditions: 'Percurso pelo vale do rio Maria da Prata, com vegetação exuberante e excelente para observação de aves.',
