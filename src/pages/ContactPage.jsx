...
const CONTACTS = [
  ...
  { icon: '📍', label: 'Endereço', value: 'Av. Alberto Torres, 111 — Alto — Teresópolis, RJ', sub: 'CEP 25964-004' },
          ...
          <div className={styles.formArea}>
            ...
            {submitted ? (
              <div className={styles.successCard}>
                ...
                <p className={styles.successText}>Obrigado, {form.name}. Retornaremos em breve para {form.email}.</p>
                <button onClick={() => { setForm(INITIAL_FORM); setSubmitted(false) }} className={styles.backBtn}>
              ...
              <form onSubmit={handleSubmit} className={styles.form} noValidate>
                ...
                <div className={styles.field}>
                  ...
                  <input id="subject" name="subject" type="text" value={form.subject} onChange={handleChange} className={`${styles.input} ${errors.subject ? styles.inputError : ''}`} placeholder="Sobre o que você quer falar?" />
                ...
                <div className={styles.field}>
                  ...
                  <textarea id="message" name="message" rows={5} value={form.message} onChange={handleChange} className={`${styles.textarea} ${errors.message ? styles.inputError : ''}`} placeholder="Escreva sua mensagem aqui..." />
